export type Messages = {
  ...
  export const en: Messages = {
    ...
    why: {
      ...
      docsDescription: "No hidden fees. All documentation is clear and upfront.",
    ...
    about: {
      ...
      body: "Ever Trust was founded to bridge the gap between quality global manufacturers and local businesses. We noticed that many wholesalers struggled with the complexities of customs, quality control, and logistics.\n\nOur mission is simple: To provide a transparent, risk-free import channel so you can focus on selling, while we handle the sourcing.",
      quote:
  ...
  export const bn: Messages = {
    ...
    products: {
      ...
      rawMaterialsDescription: "কসমেটিকস উপাদান ও ইন্ডাস্ট্রিয়াল কেমিক্যালস",
    ...
    why: {
      ...
      docsDescription: "কোনো লুকানো চার্জ নেই। সব ডকুমেন্ট পরিষ্কার ও বোধগম্য।",
      supportTitle: "লোকাল সাপোর্ট",
      supportDescription: "আমাদের লোকাল টিম সবসময় আপনাকে সহায়তা করতে প্রস্তুত।",
    },
    process: {
    ...
    compliance: {
      ...
      whoHighlight: "আমরা কোনো ব্যক্তিগত/রিটেইল কাস্টমারকে সেবা দেই না।",
    },
    about: {
      heading: "এভার ট্রাস্ট সম্পর্কে",
      body: "এভার ট্রাস্ট প্রতিষ্ঠিত হয়েছে মানসম্মত গ্লোবাল ম্যানুফ্যাকচারার এবং লোকাল ব্যবসায়ীদের মধ্যে দূরত্ব কমাতে। অনেক হোলসেলার কাস্টমস, কোয়ালিটি কন্ট্রোল এবং লজিস্টিকসের জটিলতার কারণে সমস্যায় পড়েন – আমরা সেই সমস্যা সমাধানে কাজ করি।\n\nআমাদের লক্ষ্য খুব সহজ: একটি স্বচ্ছ ও ঝুঁকিমুক্ত ইমপোর্ট চ্যানেল তৈরি করা, যাতে আপনি বিক্রিতে ফোকাস করতে পারেন এবং সোর্সিংয়ের দায়িত্ব আমরা নেই।",
      quote:
    ...
    contact: {
      ...
      subtitle: "ফর্মটি পূরণ করুন, ২৪ ঘণ্টার মধ্যে আমরা বিস্তারিত কোটেশন পাঠাবো।",
    ...
    footer: {
      brand: "এভার ট্রাস্ট",
      copyright: "© ২০২৫ এভার ট্রাস্ট। সর্বস্বত্ব সংরক্ষিত। ঢাকা, বাংলাদেশ।",
    },
  };